...
public class Question {
	...
	public Question(int questionId, String questionText, String answer1,
			String answer2, String answer3, String genre, int timesAppeared,
			int difficulty, int correctAnswer, String lastUpdate) 
	{
		super();
