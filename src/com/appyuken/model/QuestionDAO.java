...
public class QuestionDAO extends SQLiteOpenHelper {
	...
	// "/data/data/com.appyuken.frikiadospremium/databases/";
	...
	public ArrayList<Question> obtenerPreguntasCategoryMode(String category) {
		// TODO Auto-generated method stub
		ArrayList<Question> listaPreguntas = new ArrayList<Question>();
		// Aquí va toda la lógica de BBDD sqlite para acceder a la bd y obtener
				// las x preguntas (numeroPreguntas)
				// 1. build the query
				String query = "SELECT t1.IdQuestion, t1.QuestionText, t1.Answer1, t1.Answer2, t1.Answer3, t1.CorrectAnswer, t1.TimesAppeared,"
						+ " t1.Genre, t1.Difficulty FROM QUESTION t1 WHERE Difficulty > 0 AND Difficulty < 5 AND Genre = '" + category + "' ORDER BY RANDOM()";
				...
				Collections.sort(listaPreguntas, new Comparator<Question>() {
					@Override
					public int compare(Question q1, Question q2) {
						// TODO Auto-generated method stub
						return new Integer(q1.getTimesAppeared())
				...
				System.out.println("Tamaño lista preguntas categoria: " + listaPreguntas.size());
				return listaPreguntas;
	}
